...
const quizData = [
  ...
  function displayQuestion() {
    ...
    imageElement.src = `../img/test/Priority/image${currentQuestion}.png`;
    ...
    for (let i = 0; i < incorrectAnswers.length; i++) {
      ...
      incorrectAnswersHtml += `
        <div class="incorrect-answer">
          <img src="../img/test/Priority/image${questionIndex}.png" alt="Image for question" class="incorrect-image">
          <p>
